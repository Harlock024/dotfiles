...
alias pn='pnpm'
alias zed='zeditor'
alias cpp_run='function _cpp_run() { g++ -o "$1.out" "$1" && ./"$1.out"; }; _cpp_run'
alias c_run='function _c_run() { gcc -o "$1.out" "$1" && ./"$1.out" ; }; _c_run'
...
export PATH=$PATH:/home/harlock024/.spicetify
